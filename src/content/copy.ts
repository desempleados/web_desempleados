...
const es = {
  ...
  hero: {
    ...
    lead: 'Somos un equipo pequeño de desarrolladores que construye webs, apps y bots a medida. Sin agencia de por medio: hablas directo con quien escribe el código.',
  ...
  pricing: {
    ...
    ctaFixed: 'Lo quiero',
    ctaQuote: 'Cuéntame',
    note: '50% para arrancar, 50% al entregar. Transferencia, PayPal o cripto.',
  },
  why: {
...
const en: Dict = {
  ...
  hero: {
    ...
    lead: 'We are a small team of developers building custom websites, apps and bots. No agency in between: you talk directly to whoever writes the code.',
  ...
  pricing: {
    ...
    ctaFixed: 'I want this',
    ctaQuote: 'Tell us',
    note: '50% upfront, 50% on delivery. Bank transfer, PayPal or crypto.',
  },
  why: {
    label: '~/why-us',
